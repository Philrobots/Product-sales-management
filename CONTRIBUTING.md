# Contributing to GLO2003-H22-eq11 open source project

A big welcome and thank you for considering contributing to GLO2003-H22-eq11 open source projects! It’s people like you that make it a reality for users in our community.
...
Issues should be used to report problems with the library, request a new feature, or to discuss potential changes before a PR is created. When you create a new Issue, please use [this template](./.github/ISSUE_TEMPLATE/feature_request.md) for feature request 
or [this template](./.github/ISSUE_TEMPLATE/bug_report.md) for bug report.
...
- Edit an existing open source documentation.

For changes that address core functionality or would require breaking changes (e.g. a major release), it's best to open an Issue to discuss your proposal first. This is not required but can save time creating and reviewing changes.

A pull request will be integrated on our main code base only once a member of the project owner has completely review and approved the pull request.
...
Send your question to phillipe.vincent.402@gmail.com if you need any kind of help with our open source project.